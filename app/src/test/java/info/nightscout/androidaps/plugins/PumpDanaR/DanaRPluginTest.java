...
public class DanaRPluginTest {
    ...
    public void basalRateShouldBeLimited() throws Exception {
        ...
        Assert.assertEquals("DanaR: Limiting basal rate to 0.80 U/h because of pump limit", c.getMostLimitingReasons());
    }
    ...
    public void percentBasalRateShouldBeLimited() throws Exception {
        ...
        Assert.assertEquals("DanaR: Limiting percent rate to 200% because of pump limit", c.getMostLimitingReasons());
    }
